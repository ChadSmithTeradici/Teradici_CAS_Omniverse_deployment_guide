...
As it pertains to Omniverse, it generally is installed on the host system(s) that themselves particiapte in a local area networks (LANs) for optimal real-time in application collaboration. 
